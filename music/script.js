...
const songs = [
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_dark side.mp3',
    displayName: 'Dark Side',
    cover: 'music-icon.png',
  },
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_Go Down Deh.mp3',
  ...
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_Hey Mama feat Nicki Minaj Bebe Rexha  Afrojack.mp3',
    displayName: 'Let Me Down Slowly',
    cover: 'music-icon.png',
  },
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_Let Me Down Slowly.mp3',
    displayName: 'MONTERO Call Me By Your Name SATANS EXTENDED Version',
    cover: 'music-icon.png',
  },
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_MONTERO Call Me By Your Name SATANS EXTENDED Version.mp3',
    displayName: 'NEONI - Darkside (Lyrics)',
    cover: 'music-icon.png',
  },
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_NEONI - Darkside (Lyrics).mp3',
    displayName: 'On The Floor Radio Edit',
    cover: 'music-icon.png',
  },
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_Sub Urban - Freak (Lyrics) feat. REI AMI (1).mp3',
    displayName: 'Sub Urban - Freak (Lyrics) feat. REI AMI',
    cover: 'music-icon.png',
  },
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_Sub Urban - Freak (Lyrics) feat. REI AMI.mp3',
    displayName: 'Sub Urban - UH OH! (feat. BENEE) [Official Music Video]',
    cover: 'music-icon.png',
  },
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_Sub Urban - UH OH! (feat. BENEE) [Official Music Video].mp3',
    displayName: 'Unstoppable',
    cover: 'music-icon.png',
  },
  {
    path: 'C:\Users\HP\OneDrive\Desktop\music\Songs_Wonderland.mp3',
